...
import 'package:flutter_ecommerce_app/feedback.dart';
...
class _NavigationDrawerWidgetState extends State<NavigationDrawerWidget> {
  ...
  final urlImage = 'assets/logo.png';
  ...
  void selectedItem(BuildContext context, int index) {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => Sizec()));
        break;
      case 2:
        Navigator.of(context)
      ...
      case 3:
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => Feedbac()));
        break;
      case 4:
        Navigator.of(context)
